 ...
 * @author HOME
 */
public class TTD_AND_GATE extends javax.swing.JFrame {

    /**
     * Creates new form TTD_AND_GATE
     */
    public TTD_AND_GATE() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("AND Gate Truth Table");

        AND.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        AND.setForeground(new java.awt.Color(0, 0, 102));
        AND.setText("AND Gate");
        AND.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        AND.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ANDKeyPressed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(AND, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel6, jLabel8});
    ...
    private void ANDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ANDKeyPressed
        // TODO add your handling code here:
        if((evt.getKeyChar()==10)){
            AND_GATE obj=new AND_GATE();
            obj.setVisible(true);
    ...
    private void Number_Of_VariableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Number_Of_VariableKeyPressed
        ...
        if ( ((evt.getKeyChar() == 10))){
            ...
            And_Table_Generater obj=new And_Table_Generater();
    ...
    public static void main(String args[]) {
        ...
        //<editor-fold defaultstate="collapsed" desc=" Look and feel setruth_tableing code (optional) ">
        /* If Nimbus (introduced in Java SE 6) is not available, stay with the default look and feel.
         * For details see htruth_tablep://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html 
         */
        try {
            ...
            java.util.logging.Logger.getLogger(TTD_AND_GATE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TTD_AND_GATE().setVisible(true);
            }
        });
    }
