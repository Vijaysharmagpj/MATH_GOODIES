 ...
 * @author HOME
 */
public class TTD_X_OR_GATE extends javax.swing.JFrame {

    /**
     * Creates new form TTD_X_OR_GATE
     */
    public TTD_X_OR_GATE() {
        initComponents();
        
        setVisible(true);
        setResizable(false);
        setTitle("X-OR GATE TRUTH TABLE");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("X-OR Gate Truth Table");
        ...
        jLabel7.setText("X-OR GATE TRUTH TABLE");

        X_OR.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        X_OR.setForeground(new java.awt.Color(0, 0, 102));
        X_OR.setText("X-OR Gate");
        X_OR.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        X_OR.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        X_OR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                X_ORActionPerformed(evt);
            }
        });
        X_OR.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                X_ORKeyPressed(evt);
            }
        });
        ...
        Number_Of_Variable.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(X_OR, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void X_ORActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_X_ORActionPerformed
        // TODO add your handling code here:
        X_OR_GATE obj=new X_OR_GATE();
        obj.setVisible(true);
        CloseFrame();
    }//GEN-LAST:event_X_ORActionPerformed

    private void X_ORKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_X_ORKeyPressed
        // TODO add your handling code here:
        if((evt.getKeyChar()==10)){
            X_OR_GATE obj=new X_OR_GATE();
            obj.setVisible(true);
    ...
    private void Number_Of_VariableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Number_Of_VariableKeyPressed
        // TODO add your handling code here:
         if ( ((evt.getKeyChar() == 10))){
            ...
            XOr_Table_Generater obj=new XOr_Table_Generater();
    ...
    private void TTDKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTDKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_TTDKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TTD_X_OR_GATE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TTD_X_OR_GATE().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton X_OR;
